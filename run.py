...
def enter_hogwarts():
    ...
    """
    enter = input("Enter Hogwarts (yes/no)")
    if enter == "yes":
        welcome_greeting()
    elif:
        enter == "no":
